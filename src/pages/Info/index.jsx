  ...
  return (
    <Flex width={"80%"} flexDirection={"column"} alignItems={"center"} justifyContent="center" p={4}>
      ...
      <Box mt={16} textAlign="center" pb={4}>
        <Text fontWeight={"bold"} fontSize={"xl"} color="secondary.400">Desenvolvido por <Link bg={"secondary.400"} href="https://github.com/enzoggqs" isExternal color="primary.500" >Enzo Gabriel</Link></Text>
      </Box>
    </Flex>
  )
}
